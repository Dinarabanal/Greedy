...
public class Routing {
  ...
  public static void main(String[] args) {
    ...
    //Arrays.asList();  to convert arrays to list
;  }
  ...
  private static Site[] getHops(int hops) {
    ...
    return resultBuilder.toArray(new Site[0]); //converts list to array
  }
  ...
  private static void setupSites() {
    ...
    printResult(sites.toArray(new Site[0])); //converts list array
  }
